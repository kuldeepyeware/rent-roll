...
with st.sidebar:
    ...
    api_key = st.text_input("OpenRouter API Key", type="password", help="Get this from openrouter.ai")
    model_id = st.text_input("Model ID", value="anthropic/claude-haiku-4.5")
    
    st.markdown("---")
    st.markdown("This tool uses AI to standardize complex rent roll spreadsheets. A valid OpenRouter API key is recommended for optimal parsing.")
